...
function Contacts() {
  return (
    <main class="contacts-container-1">
      <div class="contacts-container-2">
        <p class="green-paliar contacts-container-paragraphe">
          Alguma pergunta? <br />
          <strong class="brown-paliar">
            Não deixe de <br />
            enviar uma <br />
            mensagem.
          </strong>
        </p>
        <form class="h5 contacts-container-forms" method="post">
          <label for="get-name">
            <span>Nome:</span>
      ...
      <div class="contacts-container-3">
        <div>
          <a
          ...
          <a
            href="https://www.linkedin.com/in/mayara-furtado-923159216/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
